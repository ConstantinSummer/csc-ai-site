...
const terms: Term[] = [
  ...
  {
    id: "cloud-computing",
    term: "Cloud Computing (Υπολογιστικό Νέφος)",
    body: (
      <>
        Η χρήση υπολογιστικών πόρων — servers, αποθηκευτικό χώρο, βάσεις
        δεδομένων, δίκτυο — μέσω διαδικτύου από πάροχο, αντί να τους έχει η
        επιχείρηση εγκατεστημένους και να τους συντηρεί η ίδια. Πληρώνετε
        ανάλογα με τη χρήση, με δυνατότητα αυτόματης κλιμάκωσης όταν αλλάζει
        η ζήτηση. Είναι, στην πράξη, και η υποδομή πάνω στην οποία τρέχουν
        τα περισσότερα σύγχρονα συστήματα Machine Learning και AI
        agents.{" "}
        <Link
